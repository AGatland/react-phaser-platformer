...
export class Preloader extends Scene {
    ...
    preload() {
        ...
        this.load.spritesheet(ASSETS.SPRITES.MUTATION_ICONS, 'icons.png', {
            frameWidth: 16,
            frameHeight: 16,
        });
    ...
    create() {
        try {
            ...
            this.anims.create({
                ...
                frames: this.anims.generateFrameNumbers(ASSETS.SPRITES.DINO, {
                    start: 11,
                    end: 13,
                }),
                frameRate: 10,
            ...
            // Ninja Roll Animations (Column 4-7, Rows 6+)
            this.anims.create({
                key: ASSETS.ANIMATIONS.NINJA_ROLL_DOWN,
                frames: this.anims.generateFrameNumbers(ASSETS.SPRITES.NINJA, { frames: [52, 60] }),
                frameRate: 12,
                repeat: -1,
            });
            ...
            this.anims.create({
                ...
                frames: this.anims.generateFrameNumbers(ASSETS.SPRITES.NINJA, { frames: [53, 61] }),
                frameRate: 12,
                repeat: -1,
            });
            ...
            this.anims.create({
                ...
                frames: this.anims.generateFrameNumbers(ASSETS.SPRITES.NINJA, { frames: [54, 62] }),
                frameRate: 12,
                repeat: -1,
            });
            ...
            this.anims.create({
                ...
                frames: this.anims.generateFrameNumbers(ASSETS.SPRITES.NINJA, { frames: [55, 63] }),
                frameRate: 12,
                repeat: -1,
            });
            ...
            console.error(error);
            this.add.text(10, 10, 'PRELOADER ERROR: ' + error.message, {
                color: '#ff0000',
                fontSize: '20px',
            });
        }
